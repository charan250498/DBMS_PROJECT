...
insert into PROJECT(project_id , project_name, objective, description, start_date, end_date, department_id, project_manager) values ('pro987','india post services project','database for postal services','create an appl to maintain data about all the mails in a database','2017-01-30','2017-09-05','dep987','amzn063');
