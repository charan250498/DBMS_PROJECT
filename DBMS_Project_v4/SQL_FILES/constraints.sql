...
alter table EMPLOYEE_PROJECT_CONTRIBUTION add foreign key (project_id) references PROJECT(project_id) on delete cascade on update cascade;
alter table EMPLOYEE_PROJECT_CONTRIBUTION add foreign key (employee_id) references EMPLOYEE(employee_id) on delete cascade on update cascade;
alter table EMPLOYEE_PROJECT_CONTRIBUTION add primary key (project_id,employee_id,on_date);
